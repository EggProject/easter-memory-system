...
| `jev/` | 2026-09-25 | A Jev (TypeSafe AI döntési modellje): mit tud, mennyire pontos, ár és kiesés, adatvédelem, hol illene nálunk, kapcsoló- és visszaállás-minták — Exa, ellenőrző körrel | 380 | — | 48 243 szó · **döntés: D-45** |
| `projekt-kontextus/` | 2026-09-25 | Honnan tudja a rendszer a projektet, és hová kerül egy új bejegyzés: MCP (roots, SEP-2567, elicitation), meglévő memória-rendszerek, kliensek projektszintű konfigurációja és hookjai, a hatókör-döntés kockázatai — Exa, ellenőrző körrel; második kör: mi kerüljön a hookon át az agent elé (önkéntes vs. beadott memória, kérdésenkénti hookok) | 598 | — | 72 118 szó · **döntés: D-48** · a 4. pont döntés előtt |
